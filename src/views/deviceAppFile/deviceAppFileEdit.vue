  ...
  export default ({
    ...
    methods: {
      ...
      async submitData(){
        ...
        if(this.pojo.id){
          // 修改
          response = await deviceAppFileApi.update(this.pojo);
        }else{
          //新增
          response = await deviceAppFileApi.add(this.pojo);
        }
      ...
      uploadMainFile(file){
        ...
        deviceAppFileApi.uploadDeviceAppFile(data).then(response=>{
      ...
      deleteDeviceAppFile(){
        ...
        if(this.pojo.fileUrl && this.pojo.fileUrl !== this.oldFileUrl){
           deviceAppFileApi.deleteDeviceAppFile(this.pojo.fileUrl);
