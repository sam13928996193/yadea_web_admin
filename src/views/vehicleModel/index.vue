<template>
  <div class="app-container" >
    ...
    <el-form :inline="true" :model="query" class="demo-form-inline" size="mini">
      ...
      <el-form-item >
        <el-input v-model.trim="query.vehicleModelCode" placeholder="车型编号" ></el-input>
      </el-form-item>
      <el-form-item >
        <el-input v-model="query.vehicleModelName" placeholder="车型名称"></el-input>
      </el-form-item>
  ...
  <!-- <el-row type="flex" class="row-bg"> -->
    ...
    :pojo="edit.pojo" :vehicleSeriesOptions="vehicleSeriesOptions" :remoteClose="remoteClose"/>
...
import Edit from '@/views/vehicleModel/edit';
...
export default ({
  ...
  methods: {
    fetchData(){
      vehicleModelApi.getList(this.query,this.page.current,this.page.size).then(response=>{
    ...
    handleEdit(id) {
      vehicleModelApi.getById(id).then(response=>{
    ...
    handleDelete(id) {
      this.$confirm('确认删除这条记录吗, 是否继续?', '提示', {
          ...
          vehicleModelApi.deleteById(id).then(response=>{
             this.$message({
