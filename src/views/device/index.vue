<template>
  <div class="app-container" >
    ...
    <el-form :inline="true" :model="query" class="demo-form-inline" size="mini">
      <el-form-item >
        <el-input v-model.trim="query.deviceSerialNo" placeholder="检测仪序列号" ></el-input>
      </el-form-item>
      <el-form-item >
        <el-input v-model="query.appVersion" placeholder="APP版本号"></el-input>
      </el-form-item>
      <el-form-item >
        <el-input v-model="query.vciVersion" placeholder="VCI版本号"></el-input>
      </el-form-item>
    ...
    <device-edit :title="edit.title" :dialogVisible="edit.dialogVisible" 
...
export default {
  ...
  methods: {
    fetchData(){
      deviceApi.getList(this.query,this.page.current,this.page.size).then(response=>{
    ...
    handleEdit(id) {
      deviceApi.getById(id).then(response=>{
    ...
    handleDelete(id) {
      this.$confirm('确认删除这条记录吗, 是否继续?', '提示', {
          ...
          deviceApi.deleteById(id).then(response=>{
             this.$message({
