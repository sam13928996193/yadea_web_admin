<template>
  <div class="app-container" >
    ...
    <el-form :inline="true" :model="query" class="demo-form-inline" size="mini">
      <el-form-item >
        <el-input v-model.trim="query.agentCode" placeholder="经销商编号" ></el-input>
      </el-form-item>
      <el-form-item >
        <el-input v-model="query.agentName" placeholder="经销商名称"></el-input>
      </el-form-item>
    ...
    <!-- 分页功能 -->
     ...
     <agent-edit :title="edit.title" :dialogVisible="edit.dialogVisible" 
...
export default {
  ...
  components: {AgentEdit},
  methods: {
    fetchData(){
      agentApi.getList(this.query,this.page.current,this.page.size).then(response=>{
    ...
    handleEdit(id) {
      agentApi.getById(id).then(response=>{
    ...
    openAdd(){
      this.edit.title='新增'
      this.edit.dialogVisible = "true"
      console.log(this.edit.dialogVisible)
    }
