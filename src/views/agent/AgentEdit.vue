<template>
    ...
    <el-form
        ...
        style="width: 400px"
      >
        <el-form-item label="经销商编号" prop="agentCode">
          <el-input v-model="pojo.agentCode"></el-input>
        </el-form-item>
        <el-form-item label="经销商名称" prop="agentName">
          <el-input v-model="pojo.agentName"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      async submitData(){
        ...
        if(this.pojo.id){
          // 修改
          response = await agentApi.update(this.pojo);
        }else{
          //新增
          response = await agentApi.add(this.pojo);
        }
